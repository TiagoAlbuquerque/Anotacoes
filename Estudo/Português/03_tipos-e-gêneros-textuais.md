...
* Personagens
    ...
    Os demais são os personagens secundários.

* Tempo
    
    O tempo é marcado cronologicamente, ou seja, determinado em horas e datas.
    Pode ser revelado por acontecimentos dispostos numa ordem sequencial e linear - início, meio e fim;
    ou psicológico, ligado às emoções e sentimentos, caracterizado pelas lembranças dos personagens, reveladas em momentos imprecisos, fundindo presente, passado e futuro.
    
* Espaço
    
    É o lugar onde ocorrem os fatos.
    Algumas vezes, é apenas sugerido para aguçar a mente do leitor.
    Outras, é completamente definido para caracterizar os personagens ou a trama de forma contundente.
    Dependendo do enredo, a caracterização do espaço é de fundamental importância como, por exemplo, nos romances regionalistas.

* Narrador
    
    Tecnicamente, é possível narrar o mesmo fato de maneiras diferentes.
    Desta forma é possível caracterizar o narrador de acordo com o seu ponto de vista.

    1. Narrador observador
        
        * Revela ao leitor somente os fatos que consegue observar.
        * Usa a 3a pessoa.
    ...
    1. Narrador onisciente
        ...
        * O narradro não apenas observa, mas conhece **tudo** sobre a história, até o pensamento dos personagens
        * Usa a 3a pessoa.
        * Não é personágem, não participa da história.
...
* Enredo
    ...
    Todo enredo é composta por um conflito vivido por um ou mais personagens.
    A história avança de acordo com as reações dos personagens aos conflitos e eventos que ocorrem ao redor dos mesmos.

    1. **Introdução** -
        É o começo da história no qual se apresentam os fatos iniciais, os personágens, e, às vezes, o tempo e o espaço.

    1. **Complicação** -
        É a parte da história em que se desenvolve o conflito.

    1. **Clímax** -
        Figura-se como o ponto culminante de toda a trama.
        Revelado pelo momento de maior tensão.
        É o momento em que o conflito atinge o seu ápice.

    1. **Conclusão** -
        É a solução do conflito instaurado.
        Pode se configurar de forma trágica, cômica, triste ou até mesmo surpreendente.

* Discurso

    É o procedimento do narrador ao reproduzir as falas ou os pensamentos dos personagens.
    Pode ser categorizado de três maneiras:

    1. Direto
        
        Neste caso, o narrador, após introduzir os personagens, faz com que eles reproduzam suas falas e pensamentos por si mesmos, de modo direto, utilizando o diálogo.

    1. Indireto

        Neste tipo de discurso não há diálogo.
        O narrador não põe os personagens para falar.
        Neste caso o próprio narrador é o interprete dos personagens.
        Ele transmite o que os personagens disseram, mas sem reproduzir o discurso que empregaram.

    1. Indireto livre
        
        Consiste na fusão entre o narrador e o personagem.
        A fala do personagem fica inserida no discurso do narrador, sem o emprego dos verbos de elocução (dizer, afirmar, perguntar, responder, pedir, exclamar).

* Linguagem e estilo

    É a forma com a qual o narrador estrutura o seu discurso, nas falas, nas descrições, nos diálogos, nas dissertações ou nos monólogos.

    * Objetiva

        Apenas informa os fatos, sem se deixar envolver emocionalmente com o que está noticiando.
        É de cunho impessoal e direto.

    * Subjetiva

        Leva-se em conta as emoções, os sentimentos envolvidos na história.
        São ressaltados os efeitos psicológicos que os acontecimentos desencadeiam nos personagens.

    * Observação

        Ocorre da mesma forma que a narração subjetiva, mas na 3a pessoa.

## Relato (Descrição)

É necessária cuidadosa observação para descrever uma pessoa, lugar ou objeto, de maneira fiel.
Não se trata, apenas, de enumerar uma série de características, mas, também, de transmitir sensações, sentimentos, aromas.

* Descrição objetiva

    Quando o objeto descrito é apresentado no sentido real.
    Exemplo: *Mede 1,85m. Pesa 70kg. Aparência atlética, ombros largos, pele bronzeada. Moreno, olhos negros, cabelos negros e lisos.*

* Descrição subjetiva

    Quando hé maior participação de emoção ou sentimentos.
    Exemplo: *Nas ocasiões de aparato é que se podia tomar pulso ao homem.
    Não só as condecorações gritavam-lhe no peito como uma couraça de grilos. 
    Ateneu! Ateneu! Aristaco todo era um anúncio; os gestos, calmos, soberanos, eram de um rei...*

### Características da descrição

* Presença de substantivos e adjetivos.
* Frases curtas dão um tom de rapidez ao texto.
* Sensibilidade para combinar e transmitir sensações físicas (cores, formas, sons, gestos, odores) e psicológicos (impressões subjetivas, comportamentos).
* Verbos de estado (ser, estar).
* Linguagem metafórica.

### Descrição x Narração

Esses dois tipos textuais misturam-se.
Em dados momentos da narração de uma história é preciso parar e descrever o ambiente, personagens, sensações.
Desta forma o leitor poderá visualizar a história.
